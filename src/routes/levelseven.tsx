...
export const Route = createFileRoute("/levelseven")({
  head: () => ({
    meta: [
      { title: "The Campfire — The Resilience Trail" },
      { name: "description", content: "Waypoint 7: Relationships & Social Wellbeing. Five questions. Drop a stone." },
    ],
  }),
...
const STAGE =
  "Night again. This time there's a fire already lit, like someone knew you'd show up. More seats than you'd expect.";

const INTRO_LINES = [
  "(sits, looks tired for the first time all night)",
  "Last one. And the one people are always weirdly bad at rating honestly.",
];

const QUESTIONS = [
  "Do you actually have relationships that support your wellbeing, or just people who show up in photos?",
  "Do you feel connected to other people, or just surrounded by them?",
  "Can you hold a boundary when you need one, or does everyone just walk straight through?",
  "Is there someone you can actually count on when it goes sideways?",
  "Do your relationships add more than they take, on balance?",
];

const OUTRO_ACTION = "(glances at the empty seats around the fire, then back at you)";
const OUTRO_SPEECH =
  "Connection's the part people forget to count, and it's not soft — it's structural. Whoever's not sitting here with you tonight is worth thinking about too.";

/* ─── Page ────────────────────────────────────────────────────────────────── */

function LevelSevenPage() {
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ marginBottom: "2rem" }}>
          <div style={{ fontSize: "0.65rem", letterSpacing: "0.35em", textTransform: "uppercase", color: LC.mutedInk, marginBottom: "0.5rem" }}>
            Waypoint 7 · Relationships &amp; Social Wellbeing
          </div>
            ...
            {phase === "outro" && (
              <div style={{ marginTop: "1rem" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end" }}>
                  <button
                    type="button"
                    onClick={() => { sessionStorage.setItem("trail-score-7", String(avg)); navigate({ to: "/reading" }); }}
    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          maxWidth: "520px", boxShadow: "0 4px 24px rgba(102,195,183,0.08)",
      ...
      <div style={{
        ...
        <img src={masqotImg} alt="The Trailkeeper" style={{
          width: "100%", maxWidth: "340px", height: "auto",
          objectFit: "contain", objectPosition: "bottom",
          filter: `drop-shadow(0 8px 32px rgba(102,195,183,0.15)) drop-shadow(0 2px 8px rgba(14,80,70,0.10))`,
          position: "relative", zIndex: 1,
        }} />
      </div>
